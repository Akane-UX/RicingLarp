        ...
        Item {
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    x: model.wType === "pet" ? 0 : model.wX
                    y: model.wType === "pet" ? 0 : model.wY
                    width: model.wType === "pet" ? 120 : ((Math.abs(Math.round(widgetProxy.wRotation || 0)) % 180 === 0) ? model.wWidth : model.wHeight)
                    height: model.wType === "pet" ? 120 : ((Math.abs(Math.round(widgetProxy.wRotation || 0)) % 180 === 0) ? model.wHeight : model.wWidth)

                    property int currentZ: index
                    // Fix overlap: Pet yang full-screen ditaruh di layer paling bawah Redactor
                    z: (widgetProxy.isSelected ? 50000 : 0) + (model.wType === "pet" ? -1000 : currentZ)
