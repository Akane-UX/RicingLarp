    ...
    readonly property var types: ({
        "visualizer": {
            ...
            variants: {
                ...
                "neon": { file: "faces/VisualizerFaceNeon.qml", icon: "3", label: "Neon" }
            },
            additionalSettings: [
                {
                    id: "stretchWidth",
        ...
        "lyrics": {
            name: I18n.t("widgets.types.lyrics"),
            icon: "󰝚",
            iconOffsetX: 0,
            defaultWidth: 500,
            defaultHeight: 100,
            defaultVariant: "default",
            variants: {
                "default": { file: "faces/LyricsFace.qml", icon: "B", label: "Bold" },
                "medium": { file: "faces/LyricsFaceMedium.qml", icon: "M", label: "Medium" },
                "light": { file: "faces/LyricsFaceLight.qml", icon: "L", label: "Light" },
                "italic": { file: "faces/LyricsFaceItalic.qml", icon: "I", label: "Italic" }
            },
            additionalSettings: [
                {
                    id: "stretchWidth",
        ...
        "pet": {
            ...
            icon: "󰄛",
            iconOffsetX: 0,
            defaultWidth: Quickshell.screens && Quickshell.screens.length > 0 ? Quickshell.screens[0].width : 1920,
            defaultHeight: Quickshell.screens && Quickshell.screens.length > 0 ? Quickshell.screens[0].height : 1080,
            defaultVariant: "default",
            variants: {
                "default": { file: "faces/PetFace.qml", icon: "1", label: "Cat" }
            },
            additionalSettings: [
                {
                    id: "stretchWidth",
